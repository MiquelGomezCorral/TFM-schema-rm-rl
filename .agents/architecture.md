...
The local sibling packages `../nl2ltl` and `../Flat` are editable development dependencies. MONA remains an external executable. V1 stops after Reward Machine generation and does not depend on an RL runtime.
